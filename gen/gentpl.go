...
var files = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/_assetgen.scss": &vfsgen۰CompressedFileInfo{
			name:             "_assetgen.scss",
			modTime:          time.Date(2019, 9, 15, 1, 12, 42, 38475357, time.UTC),
		...
		"/assets.anko": &vfsgen۰FileInfo{
			name:    "assets.anko",
			modTime: time.Date(2019, 9, 15, 1, 12, 42, 38490549, time.UTC),
		...
		"/gitignore": &vfsgen۰FileInfo{
			name:    "gitignore",
			modTime: time.Date(2019, 9, 15, 1, 12, 42, 38503115, time.UTC),
		...
		"/manifest.go": &vfsgen۰CompressedFileInfo{
			name:             "manifest.go",
			modTime:          time.Date(2019, 9, 15, 1, 12, 42, 38534380, time.UTC),
		...
		"/manifest.go.extra": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2019, 9, 15, 1, 12, 42, 38546685, time.UTC),
		...
		"/package.json": &vfsgen۰CompressedFileInfo{
			name:             "package.json",
			modTime:          time.Date(2019, 9, 15, 1, 12, 42, 38560554, time.UTC),
		...
		"/sass.js": &vfsgen۰CompressedFileInfo{
			name:             "sass.js",
			modTime:          time.Date(2019, 9, 15, 1, 12, 42, 38581487, time.UTC),
