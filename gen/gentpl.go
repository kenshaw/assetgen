...
var files = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/assets.anko": &vfsgen۰FileInfo{
			name:    "assets.anko",
			modTime: time.Date(2018, 12, 2, 12, 59, 25, 857876621, time.UTC),
		...
		"/gitignore": &vfsgen۰FileInfo{
			name:    "gitignore",
			modTime: time.Date(2018, 12, 2, 12, 59, 25, 857914100, time.UTC),
		...
		"/manifest.go": &vfsgen۰CompressedFileInfo{
			name:             "manifest.go",
			modTime:          time.Date(2018, 12, 2, 12, 59, 25, 857957739, time.UTC),
		...
		"/manifest.go.extra": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2018, 12, 2, 12, 59, 25, 857982821, time.UTC),
		...
		"/package.json": &vfsgen۰CompressedFileInfo{
			name:             "package.json",
			modTime:          time.Date(2018, 12, 2, 12, 59, 25, 858011233, time.UTC),
		...
		"/sass.js": &vfsgen۰CompressedFileInfo{
			name:             "sass.js",
			modTime:          time.Date(2018, 12, 2, 12, 59, 25, 858050920, time.UTC),
		...
		"/yarnrc": &vfsgen۰FileInfo{
			name:    "yarnrc",
			modTime: time.Date(2018, 12, 2, 12, 59, 25, 858074887, time.UTC),
