...
var files = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/_assetgen.scss": &vfsgen۰CompressedFileInfo{
			name:             "_assetgen.scss",
			modTime:          time.Date(2019, 1, 13, 3, 39, 12, 405006973, time.UTC),
		...
		"/assets.anko": &vfsgen۰FileInfo{
			name:    "assets.anko",
			modTime: time.Date(2019, 1, 13, 3, 39, 12, 405030404, time.UTC),
		...
		"/gitignore": &vfsgen۰FileInfo{
			name:    "gitignore",
			modTime: time.Date(2019, 1, 13, 3, 39, 12, 405052844, time.UTC),
		...
		"/manifest.go": &vfsgen۰CompressedFileInfo{
			name:             "manifest.go",
			modTime:          time.Date(2019, 1, 13, 3, 39, 12, 405085777, time.UTC),
		...
		"/manifest.go.extra": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2019, 1, 13, 3, 39, 12, 405106323, time.UTC),
		...
		"/package.json": &vfsgen۰CompressedFileInfo{
			name:             "package.json",
			modTime:          time.Date(2019, 1, 13, 3, 39, 12, 405125749, time.UTC),
		...
		"/sass.js": &vfsgen۰CompressedFileInfo{
			name:             "sass.js",
			modTime:          time.Date(2019, 1, 13, 3, 39, 12, 405154414, time.UTC),
		...
		"/yarnrc": &vfsgen۰FileInfo{
			name:    "yarnrc",
			modTime: time.Date(2019, 1, 13, 3, 39, 12, 405172920, time.UTC),
