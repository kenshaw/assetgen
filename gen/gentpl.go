...
var files = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/_assetgen.scss": &vfsgen۰CompressedFileInfo{
			name:             "_assetgen.scss",
			modTime:          time.Date(2019, 1, 12, 5, 14, 27, 466075698, time.UTC),
			uncompressedSize: 258,

			compressedContent: []byte(""),
		},
		"/assets.anko": &vfsgen۰FileInfo{
			name:    "assets.anko",
			modTime: time.Date(2019, 1, 12, 5, 14, 27, 466110431, time.UTC),
		...
		"/gitignore": &vfsgen۰FileInfo{
			name:    "gitignore",
			modTime: time.Date(2019, 1, 12, 5, 14, 27, 466159379, time.UTC),
		...
		"/manifest.go": &vfsgen۰CompressedFileInfo{
			name:             "manifest.go",
			modTime:          time.Date(2019, 1, 12, 5, 14, 27, 466210438, time.UTC),
		...
		"/manifest.go.extra": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2019, 1, 12, 5, 14, 27, 466254484, time.UTC),
		...
		"/package.json": &vfsgen۰CompressedFileInfo{
			name:             "package.json",
			modTime:          time.Date(2019, 1, 12, 5, 14, 27, 466295589, time.UTC),
		...
		"/sass.js": &vfsgen۰CompressedFileInfo{
			name:             "sass.js",
			modTime:          time.Date(2019, 1, 12, 5, 14, 27, 466365372, time.UTC),
		...
		"/yarnrc": &vfsgen۰FileInfo{
			name:    "yarnrc",
			modTime: time.Date(2019, 1, 12, 5, 14, 27, 466408666, time.UTC),
