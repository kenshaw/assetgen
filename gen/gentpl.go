...
var files = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/_assetgen.scss": &vfsgen۰CompressedFileInfo{
			name:             "_assetgen.scss",
			modTime:          time.Date(2020, 4, 25, 8, 2, 54, 324574530, time.UTC),
		...
		"/assets.anko": &vfsgen۰FileInfo{
			name:    "assets.anko",
			modTime: time.Date(2020, 4, 25, 8, 2, 54, 324586813, time.UTC),
		...
		"/gitignore": &vfsgen۰FileInfo{
			name:    "gitignore",
			modTime: time.Date(2020, 4, 25, 8, 2, 54, 324598816, time.UTC),
		...
		"/manifest.go": &vfsgen۰CompressedFileInfo{
			name:             "manifest.go",
			modTime:          time.Date(2020, 4, 25, 8, 2, 54, 324638110, time.UTC),
		...
		"/manifest.go.extra": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 4, 25, 8, 2, 54, 324654100, time.UTC),
		...
		"/package.json": &vfsgen۰CompressedFileInfo{
			name:             "package.json",
			modTime:          time.Date(2020, 4, 25, 8, 2, 54, 324668948, time.UTC),
		...
		"/postcss.config.js": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 4, 25, 8, 2, 54, 324683144, time.UTC),
			uncompressedSize: 257,

			compressedContent: []byte(""),
		},
		"/sass.js": &vfsgen۰CompressedFileInfo{
			name:             "sass.js",
			modTime:          time.Date(2020, 4, 25, 8, 2, 54, 324706989, time.UTC),
