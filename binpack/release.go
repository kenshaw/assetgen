...
func writeRelease(w io.Writer, c *Binpack, toc []Asset) error {
	var err error

	if err = writeReleaseHeader(w, c); err != nil {
		return err
	}
...
func writeReleaseHeader(w io.Writer, c *Binpack) error {
	var err error
	if c.NoCompress {
		if c.NoMemCopy {
...
func writeReleaseAsset(w io.Writer, c *Binpack, asset *Asset) error {
...
func asset_release_common(w io.Writer, c *Binpack, asset *Asset) error {
